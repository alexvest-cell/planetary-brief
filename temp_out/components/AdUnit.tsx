...
const AdUnit: React.FC<AdUnitProps> = ({ className = '', format = 'auto', slotId = '1234567890', layoutKey }) => {
  ...
  return (
    <div className={`group relative overflow-hidden bg-zinc-900/30 border border-white/5 rounded-sm flex flex-col items-center justify-center text-center transition-colors hover:bg-zinc-900/50 min-h-[100px] ${className}`}>
