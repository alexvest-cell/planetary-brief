...
const topics = [
  { id: 'Oceans', label: 'Oceans & Marine Life' },
  { id: 'Forests', label: 'Forests & Biodiversity' },
  { id: 'Energy', label: 'Energy Transition' },
  { id: 'Food', label: 'Sustainable Food Systems' },
  { id: 'Cities', label: 'Urban Future' },
  { id: 'Justice', label: 'Climate Justice' },
  { id: 'Economy', label: 'Green Economy' },
  { id: 'Pollution', label: 'Pollution & Waste' },
