...
const DataExplanationView: React.FC<DataExplanationViewProps> = ({ data, onBack }) => {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans pt-24 pb-24 animate-fade-in relative">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-4xl">
        ...
        <button 
            onClick={onBack}
            className="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors mb-8 font-medium text-xs tracking-widest uppercase"
        >
