...
const extendContent = (base: string[], category: string, topic: string): string[] => {
...
const generateBodyContent = (category: string, topic: string, excerpt: string): string[] => {
    return [
        excerpt,
...
export const heroContent = {
  ...
  imageUrl: "https://images.unsplash.com/photo-1591193686104-fddba4d0e4d8?q=80&w=2069&auto=format&fit=crop", // Supermarket/Plastic shelves
...
const featuredBase: Article = {
  ...
  topic: 'Pollution',
  source: 'GreenShift Original',
  imageUrl: 'https://images.unsplash.com/photo-1591193686104-fddba4d0e4d8?q=80&w=2069&auto=format&fit=crop', // Supermarket context
  secondaryImageUrl: 'https://images.unsplash.com/photo-1530587191325-3db32d826c18?q=80&w=2070&auto=format&fit=crop', // Plastic bottles
  diagramUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop',
...
const createArticle = (id: string, title: string, category: 'Science' | 'Policy' | 'Innovation' | 'Economy' | 'Action' | 'Opinion' | 'Conservation', topic: string, excerpt: string, date: string, imageUrl: string): Article => ({
  id,
  title,
  category,
  topic,
...
export const upcomingEvents: Article[] = [
    {
        ...
        topic: 'Global Summit',
        source: 'UNFCCC',
        imageUrl: 'https://images.unsplash.com/photo-1623862402179-c5c8328c0542?q=80&w=2070', // Conference/UN
    ...
    },
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1618477461853-5f8dd68aa395?q=80&w=2070', // Plastic bottle beach
    ...
    },
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1559869502-d4b68e918459?q=80&w=2070', // Ship container
    ...
    },
     {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1440342359726-241830823657?q=80&w=2070', // Jungle forest
