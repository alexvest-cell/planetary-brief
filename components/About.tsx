        ...
        <section id={Section.ABOUT} className="py-8 md:py-12 bg-zinc-950 border-y border-white/5">
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-zinc-900/40 border border-white/10 p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-8 group">
                    ...
                    <div className="flex items-start md:items-center gap-6 relative z-10 w-full lg:w-auto">
                        ...
                        <div className="flex flex-col">
                            <h2 className="text-xl md:text-2xl font-serif font-bold text-white mb-1 flex flex-col md:flex-row md:items-center md:gap-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 w-full lg:w-auto flex-shrink-0 relative z-10 border-t lg:border-t-0 lg:border-l border-white/5 pt-6 lg:pt-0 lg:pl-8">
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto">
                            ...
                            >
                                Methodology <ArrowRight size={12} />
                            </button>
                            <button
                                onClick={onShowSources}
                                className="flex-1 md:flex-none py-2 px-4 bg-transparent border border-white/20 text-white text-[10px] md:text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-white/5 transition-colors"
                            >
                                Sources
                            </button>
                        </div>
