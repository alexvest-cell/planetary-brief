...
const Hero: React.FC<HeroProps> = ({ onReadFeatured, onArticleClick, featuredArticleOverride }) => {
    ...
    return (
        <section id={Section.HERO} className="relative w-full bg-black text-white pt-8 md:pt-12 pb-12 overflow-hidden border-b border-white/5">
            {/* Background elements */}
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-stretch">
                    ...
                    <div className="lg:col-span-5 flex flex-col order-2 lg:order-1 py-4">

                        {/* Signal / Category */}
                        <div className="flex items-center gap-3 mb-6">
                            <span className="bg-news-accent/10 border border-news-accent/20 px-2 py-1 rounded text-[10px] font-bold uppercase tracking-widest text-news-accent flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-news-accent shadow-[0_0_5px_#10b981]"></span>
                        ...
                        {/* Headline */}
                        <h1
                            className="text-4xl md:text-5xl xl:text-6xl font-serif font-bold leading-[1.1] mb-6 text-white hover:text-gray-200 cursor-pointer transition-colors tracking-tight"
                        ...
                        <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed mb-8 border-l-2 border-news-accent/30 pl-6">
                            {displaySubheadline}
                        </p>
                        ...
                        <div className="flex items-center gap-6 mt-auto">
                            <button
                                onClick={onReadFeatured}
                                className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest bg-white text-black px-6 py-3 rounded-sm hover:bg-gray-200 transition-colors"
                            >
                    ...
                    <div className="lg:col-span-7 order-1 lg:order-2 h-full py-4">
                        <div
