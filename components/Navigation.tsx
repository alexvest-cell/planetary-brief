...
const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex flex-col font-sans overflow-visible">
      ...
      {/* Top Bar (Primary Nav) */}
      <div className={`w-full transition-all duration-300 overflow-visible ${isScrolled ? 'bg-black/95' : 'bg-black/80'} backdrop-blur-md`}>
      ...
      <div className={`relative w-full transition-all duration-300 hidden md:flex ${isScrolled ? 'h-10 bg-black/95' : 'h-12 bg-black/80'} backdrop-blur-md`}>
          ...
          <div className="absolute top-full left-0 w-full bg-black z-40 p-4 sm:p-6 md:px-8 animate-fade-in md:hidden border-b border-white/10 shadow-2xl pb-6">
            ...
            <div className="grid grid-cols-[1.3fr_1fr] gap-x-3 sm:gap-x-4">
              ...
              <div className="flex flex-col border-r border-white/10 pr-3 sm:pr-4">
                <h3 className="text-[9px] text-news-accent font-sans font-bold uppercase tracking-widest mb-4">Intelligence By Sector</h3>
                <div className="flex flex-col gap-5 text-[11px] font-sans font-normal uppercase tracking-widest text-white">
              ...
              <div className="flex flex-col pl-1 sm:pl-2">
                ...
                <div className="mb-8">
                  <h3 className="text-[9px] text-news-accent font-sans font-bold uppercase tracking-widest mb-4">Intelligence Tools</h3>
                  <div className="flex flex-col gap-4 text-[11px] font-sans font-normal uppercase tracking-widest text-white">
                ...
                {/* SECTION: ABOUT */}
                <div className="mb-8">
                  <h3 className="text-[9px] text-news-accent font-sans font-bold uppercase tracking-widest mb-4">About</h3>
