...
const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex flex-col font-sans overflow-visible">
      ...
      {/* Top Bar (Primary Nav) */}
      <div className={`w-full transition-all duration-300 overflow-visible bg-black`}>
      ...
      <div className={`relative w-full bg-black transition-all duration-300 hidden md:flex ${isScrolled ? 'h-10' : 'h-12'}`}>
